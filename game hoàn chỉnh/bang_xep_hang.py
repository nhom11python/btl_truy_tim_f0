...
#Nhập thành tích mới
xep_hang.Them_du_lieu(29,1)      #Nhập (thời gian hoàn thành, độ khó)  (1 = dễ, 2 = bình thường, 3 = khó)
#xep_hang.Them_du_lieu_tuy_chon(5,14,4,6)     #Nhập   (Tg hoàn thành, độ rộng bảng, số f0, số f0 max)

#Ghi dữ liệu vào file
xep_hang.Ghi_du_lieu_all()
xep_hang.Ghi_du_lieu_tuy_chon()

#mở cửa sổ thành tích
